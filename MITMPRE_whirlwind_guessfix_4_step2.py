...
class Constraints_generator():
    ...
    def genConstraints_total(self):
        ...
        for j in range(8):                
            constr = constr + [BasicTools.plusTerm(input1_round[6+8*j:8+8*j])+ ' = 2']
            constr = constr + [BasicTools.plusTerm(input2_round[6+8*j:8+8*j])+ ' = 2']        
    ...
    def genModel(self, filename):
        ...
        fid = open('./Model/TR' + str(self.TR) + '_ini' + str(self.ini_r) + '_matr' + str(self.mat_r) + '_2.lp', 'w')
...
def cmd():
    rd = open('./Model/Result_fix_step2.txt', 'w')
        ...
        for ini_r in range(0, TR):
            for mat_r in range(0, TR):
                if mat_r != ini_r:                        
                    ...
                    A.genModel('')
                    name = './Model/TR' + str(TR) + '_ini' + str(ini_r) + '_matr' + str(mat_r)+'_2'
